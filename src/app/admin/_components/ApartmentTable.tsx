  ...
  return (
    <div className="rounded-xl bg-white shadow-sm">
      ...
      <div className="relative">
        {isPending && (
          <div className="absolute inset-0 z-10 flex items-center justify-center rounded-b-xl bg-white/70 backdrop-blur-[1px]">
            <svg
              className="h-8 w-8 animate-spin text-red-700/50"
